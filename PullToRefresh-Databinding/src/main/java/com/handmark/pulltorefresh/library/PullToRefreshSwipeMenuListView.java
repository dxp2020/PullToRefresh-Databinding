...
import com.handmark.pulltorefresh.library.swipe.MySwipeMenuListView;
import com.shangtao.refresh.R;


public class PullToRefreshSwipeMenuListView extends PullToRefreshAdapterViewBase<MySwipeMenuListView> {
    ...
    protected MySwipeMenuListView createListView(Context context, AttributeSet attrs) {
        final MySwipeMenuListView lv;
    ...
    @Override
    protected MySwipeMenuListView createRefreshableView(Context context, AttributeSet attrs) {
        MySwipeMenuListView lv = createListView(context, attrs);
    ...
    protected class InternalListView extends MySwipeMenuListView implements EmptyViewMethodAccessor {
